...
Complete function howManydays, function accept 1 parameters:
month, means the month of year, different month has different 
days (refer to the following table), return a number that how 
many days in this month(month is always greater than 0, less 
than or equal to 12).
...
function howManydays(month) {
	let days; // ds variable = d return value;

	switch(month) {	//switch tks d parameter
		case 1:
		case 3:
		case 5:
		case 7:
		...
		default:
			days ="Enter a number between: 1 - 12"
		
	}

	return days; // days is return outside d loop
}

console.log(howManydays(0));